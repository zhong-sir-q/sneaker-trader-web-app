...
const onFederatedSignin = (
  UserInstance: UserController,
  UserRegistrationInstance: UserRegistrationController
) => async (provider: SocialProvider, token: string, expires_at: number, user: { email: string; name: string }) => {
