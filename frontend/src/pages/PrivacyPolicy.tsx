...
const PrivacyPolicy = () => {
  return (
    <Container fluid='sm'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Sneaker Trader Limited, 18 Centre Street, Auckland.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sneaker Trader, accessible from{' '}
            <Link to='https://www.sneakertrader.com' target='_blank'>
              https://www.sneakertrader.com
            </Link>
          </p>
        </li>
        <li>
      ...
      <p>
        Usage Data may include information such as Your Device&lsquo;s Internet Protocol address (e.g. IP address),
      ...
      <ul>
        ...
        <li>
          ...
          electronic communication, such as a mobile application&lsquo;s push notifications regarding updates or
      ...
      <p>
        Your information, including Personal Data, is processed at the Company&lsquo;s operating offices and in any
      ...
      <p>
        Under California Civil Code Section 1798 (California&lsquo;s Shine the Light law), California residents with an
        established business relationship with us can request information once a year about sharing their Personal Data
        with third parties for the third parties&lsquo; direct marketing purposes.
      </p>
      <p>
        If you&lsquo;d like to request more information under the California Shine the Light law, and if you are a
      ...
      <p>
        ...
        You will be directed to that third party&lsquo;s site. We strongly advise You to review the Privacy Policy of
