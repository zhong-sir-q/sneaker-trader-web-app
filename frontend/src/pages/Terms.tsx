  ...
  return (
    <Container fluid='sm'>
      ...
      <p>
        ...
        requirements) may apply. Additional terms will be available with the relevant Services, and those additional
      ...
      <p>
        ...
        instructions that we provide. You may use our Services only as permitted by law, including applicable export and
        re-export control laws and regulations. We may suspend or stop providing our Services to you if you do not
      ...
      <p>
        Some of our Services are available on mobile devices. Do not use such Services in a way that distracts you and
      ...
      <p>
        Only authorized employees within the company who, in the course of their duties, can access and use information
      ...
      <p>
        ...
        Government authorities have created specific offences for unauthorized actions against computer systems and
        data. We will investigate such actions with a view to bringing legal action and/or civil action for damages
      ...
      <p>
        No refund will be offered when a service is deemed to have commenced and is, for all intents and purposes, in
        progress. Any amount paid to us that constitutes payment for the provision of unused Services, will be refunded.
      </p>
      ...
      <p>
        Like most interactive websites, this Company’s website uses cookies to enable us to retrieve user details for
      ...
      <p>
        You should evaluate the security and reliability of any other site linked to or accessed through this site
        before disclosing any personal information to them. This company will not accept any liability for any loss or
        damage, in any manner whatsoever, regardless of the cause, resulting from your disclosure of personal
      ...
      <p>
        You may not create a link to a page on this website without our prior written consent. If you link to any page
        on this website, you do so at your own risk and the exclusions and limitations set out above apply to your use
        of this website.{' '}
      </p>
      ...
      <p>
        ...
        and the full content of this website. This Company’s logo is a registered trademark of this Company in the
        United Kingdom and other countries. The brand names and specific services of this Company featured on this web
      ...
      <p>
        If you do not comply with these terms, and we don’t act right away, this doesn’t mean that we are giving up any
